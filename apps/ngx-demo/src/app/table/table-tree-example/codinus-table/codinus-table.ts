...
import {
    ...
    CSTableDataSource,
    CSTableTreeDirective,
    CSTableTreeRelationDataHandler,
    ICSTableApi,
    ICSTableColumn, ICSTableTreeColumn, SelectionType
} from '@ngx-codinus/material/table';
import { TableTreeButtonsComponent } from '../table-tree-buttons/table-buttons';
...
@Component({
    ...
    imports: [CommonModule, MatTableModule, TableTreeButtonsComponent, CSTableTreeRelationDataHandler,
        CodinusTableModule,
        MatSortModule,
        CSTableTreeDirective,
        //FilterTextCustom, 
...
export class CdoinusTableTreeExampleComponent {
    ...
    treeColumn: ICSTableTreeColumn<PeriodicElement> = {
        dataKey: 'position', footerAggregation: 'sum', label: 'No.',
