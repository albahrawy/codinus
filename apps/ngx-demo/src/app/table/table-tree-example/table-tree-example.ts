...
@Component({
  selector: 'mat-table-virtual-scroll-tree',
  templateUrl: './table-tree-example.html',
  styleUrls: ['./table-tree-example.scss'],
  // animations: [rowsAnimation],
  imports: [
    CommonModule, TableTreeButtonsComponent, MatTableModule,
    CodinusTableModule,
    CSTableTreeRelationDataHandler,
    CSTableTreeCell,
    MatSortModule,
