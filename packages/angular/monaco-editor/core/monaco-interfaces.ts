...
export type IMonacoEditor = typeof monaco.editor;
export type ICodeEditor = monaco.editor.ICodeEditor;
export type IStandaloneCodeEditor = monaco.editor.IStandaloneCodeEditor;
export type IEditorOptions = monaco.editor.IEditorOptions & { theme?: string; };
export enum ShowLightbulbIconMode {
	Off = 'off',
	OnCode = 'onCode',
	On = 'on'
}
export type IMonacoLanguages = typeof monaco.languages & {
...
export interface IEditorActionDescriptorCustom extends IEditorActionDescriptorBase {
	type: 'custom',
	/**
...
export interface IEditorActionDescriptorCode extends IEditorActionDescriptorBase {
	type?: 'code',
	/**
	 * Method that will be executed when the action is triggered.
	 * @param editor The editor instance is passed in as a convenience
	 */
	run(args: IEditorActionArgs): string | Promise<string> | Observable<string>;
}

export type IEditorActionDescriptor = IEditorActionDescriptorCode | IEditorActionDescriptorCustom;

export interface IEditorActionArgs {
...
export interface IEditorIExtraLibs {
	[path: string]: IExtraLib;
}

export declare type IMonaco = typeof monaco & {
	editor: IMonacoEditor;
	languages: IMonacoLanguages;
}


declare type requireFnType = (path: string | string[], callback: () => void) => void;
declare type requireType = requireFnType & {
	config(options: IRecord<string | IGenericRecord>): void;
}

declare global {

	interface Window {
		monaco?: IMonaco | undefined;
		require?: requireType;
	}
}
...
declare namespace monaco.editor {
	...
	*/
	 ...
	 */
	export type IModelLanguageConfigurationChangedEvent = object
	...
	export const EditorOptions: {
		...
		rulers: IEditorOption<EditorOption.rulers, IGenericRecord>;
		...
		wordSegmenterLocales: IEditorOption<EditorOption.wordSegmenterLocales, IGenericRecord>;
...
declare namespace monaco.languages {
	...
	export type FoldingContext = object
...
declare namespace languages.typescript {
	...
	export interface Diagnostic extends DiagnosticRelatedInformation {
		...
		reportsUnnecessary?: IGenericRecord;
		reportsDeprecated?: IGenericRecord;
		source?: string;
	...
	export interface LanguageServiceDefaults {
		 ...
		 */
		readonly onDidChange: monaco.IEvent<void>;
		/**
		 * Event fired when extra libraries registered with the language service change.
		 */
		readonly onDidExtraLibsChange: monaco.IEvent<void>;
		 ...
		 */
		getExtraLibs(): IEditorIExtraLibs;
		/**
	...
	export const getTypeScriptWorker: () => Promise<(...uris: monaco.Uri[]) => Promise<TypeScriptWorker>>;
	export const getJavaScriptWorker: () => Promise<(...uris: monaco.Uri[]) => Promise<TypeScriptWorker>>;
}