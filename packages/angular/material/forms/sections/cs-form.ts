import { AfterViewInit, booleanAttribute, Component, computed, effect, forwardRef, input, model, OnInit, output } from '@angular/core';
import { outputFromObservable, takeUntilDestroyed, toSignal } from '@angular/core/rxjs-interop';
import { AbstractControl, ControlContainer, FormGroup, FormGroupDirective, ValueChangeEvent } from '@angular/forms';
...
import { CODINUS_UPLOAD_MANAGER, ICSDirtyComponent, ICSFormFile, ICSUploadManager } from '@ngx-codinus/core/shared';
...
export class CSForm extends CSFormGroupDirectiveBase implements ICSDirtyComponent, ICSUploadManager, OnInit, AfterViewInit {

    private _files: ICSFormFile[] = [];
    private _removedFiles: string[] = [];

    initialized = output<CSForm>();
