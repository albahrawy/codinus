...
@Component({
    selector: 'cs-runtime-form-element-text-area',
    template: `
            <textarea matInput [readonly]="config().readOnly" [initialDisableStatus]="config().disabled"
...
export class CSFormElementTextArea extends CSRunTimeFormValidableElementBase<ICSRuntimeFormFieldText, string> { }