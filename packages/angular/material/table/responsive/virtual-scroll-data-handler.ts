...
// import { Observable, combineLatest, distinctUntilChanged, map, of, shareReplay } from "rxjs";
...
// @Directive({
//     selector: `cdk-table:not([dataSource])[responsive][virtual-scroll], 
//                mat-table:not([dataSource])[responsive][virtual-scroll]`,
//     providers: [{
