...
export interface IHasBody<T extends NodeBase, N extends boolean = false> { body: N extends true ? Nullable<T> : T; }
...
export interface IHasExpression<T extends NodeBase, N extends boolean = true> { expression: N extends true ? T | undefined : T; }
...
export interface ICompositeExpression<L extends NodeBase, R extends NodeBase> { left: L; right: R; }
export interface ICompositeOperatorNode<T extends string, L extends NodeBase, R extends NodeBase, O extends AnyOperator>
    extends IHasOperator<O>, ICompositeNode<T, L, R> { }
export interface ICompositeNode<T extends string, L extends NodeBase, R extends NodeBase> extends INodeBase<T>, ICompositeExpression<L, R> { }
