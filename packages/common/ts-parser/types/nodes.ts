...
export type IHasAnyBody = IHasBody<ExpressionNode>
export type IHasAnyChildren = IHasChildren<ExpressionNode>
export type IHasAnyExpression<N extends boolean = true> = IHasExpression<ExpressionNode, N>
export type IHasAnyArgument<T extends boolean = true> = IHasArgument<ExpressionNode, T>
...
export interface Identifier extends IPatternBase<"Identifier">, IHasDecorators { name: string; optional?: true | null; }
...
export interface IBlockStatement extends INodeBase<"BlockStatement">, IHasAnyChildren, IHasDirectives { }
...
export type IForInStatement = IForInOfBase<"ForInStatement">

export type IForOfStatement = IForInOfBase<"ForOfStatement">
...
export type IClassExpression = IClassBase<"ClassExpression">
...
export type IAssignmentExpression = ICompositeOperatorNode<"AssignmentExpression", ExpressionNode | IPattern, ExpressionNode, AssignmentOperator>
export type ILogicalExpression = ICompositeOperatorNode<"LogicalExpression", ExpressionNode, ExpressionNode, LogicalOperator>
export type IBinaryExpression = ICompositeOperatorNode<"BinaryExpression", ExpressionNode, ExpressionNode, BinaryOperator>
...
export interface ICallOrNewExpression extends INodeBase<"CallExpression" | "NewExpression" | "OptionalCallExpression"> {
    ...
    optional?: boolean;
    typeParameters?: TsTypeParameterInstantiation; //IHasParams<NodeBase> && ;
}
...
export type IExportDefaultSpecifier = IModuleSpecifier<"ExportDefaultSpecifier">

export type IImportDefaultSpecifier = IModuleSpecifier<"ImportDefaultSpecifier">

export type IImportNamespaceSpecifier = IModuleSpecifier<"ImportNamespaceSpecifier">
export type IExportNamespaceSpecifier = IModuleSpecifier<"ExportNamespaceSpecifier">
...
export type ITsQualifiedName = ICompositeNode<"TSQualifiedName", TsEntityName, Identifier>
...
export type TsSignatureDeclarationBase<T extends string> = TsSignatureDeclarationOrIndexSignatureBase<T> & IHasTsTypeParameterDeclaration;
export type TsCallSignatureDeclaration = TsSignatureDeclarationBase<"TSCallSignatureDeclaration">;
export type TsConstructSignatureDeclaration = TsSignatureDeclarationBase<"TSConstructSignatureDeclaration">;

export type TsTypeParameterDeclaration = INodeBase<"TSTypeParameterDeclaration"> & IHasParams<TsTypeParameter>;
...
export type TsUnionType = TsUnionOrIntersectionTypeBase<"TSUnionType">;
export type TsIntersectionType = TsUnionOrIntersectionTypeBase<"TSIntersectionType">;
...
export type TsFunctionType = TsSignatureDeclarationBase<"TSFunctionType">;
